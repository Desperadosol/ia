...
//gives me access to the user document from the firestore with the unique user ID 
...
//allows me to modify the contents of the user document.
...
export async function addEvent(event) {
  ...
  //adding additional field with the id of the document
...
//Saves the teacher password to the Firestore database.
...
//Retrieves the teacher password from the Firestore database.
